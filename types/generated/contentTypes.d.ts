...
export interface ApiAreaArea extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    geo_content: Schema.Attribute.Relation<
      'oneToOne',
      'api::geo-content.geo-content'
    >;
...
export interface ApiChatChat extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    chat_status: Schema.Attribute.Enumeration<
    ...
    isGuest: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiClickTargetClickTarget extends Struct.CollectionTypeSchema {
  collectionName: 'click_targets';
  info: {
    displayName: 'Click Tracking';
    pluralName: 'click-targets';
    singularName: 'click-target';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    listing_name: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::click-target.click-target'
    > &
      Schema.Attribute.Private;
...
export interface ApiCompanyLocationCompanyLocation
  ...
  attributes: {
    ...
    years_in_business: Schema.Attribute.Decimal;
...
export interface ApiGeoContentGeoContent extends Struct.CollectionTypeSchema {
  collectionName: 'geo_contents';
  info: {
    displayName: 'Geo Content';
    pluralName: 'geo-contents';
    singularName: 'geo-content';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiMessageMessage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<['user', 'assistant', 'syestem']>;
    sessionId: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSettingSetting extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'>;
    status_type: Schema.Attribute.Enumeration<['Active', 'In Active']> &
